class Suggest < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    url "https://github.com/tedfulk/suggest/releases/download/v0.1.57/suggest-darwin-amd64.tar.gz"
    sha256 "f80afd643c3f454a6c1f7f78175ce45c5a34e3d3531886fa6483033858361749"
  elsif OS.linux? && Hardware::CPU.intel?
    url "https://github.com/tedfulk/suggest/releases/download/v0.1.57/suggest-linux-amd64.tar.gz"
